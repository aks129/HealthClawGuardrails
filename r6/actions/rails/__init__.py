...
from r6.actions.rails import curatr_fix, form_fill, phone, sms, webhook_poster  # noqa: E402  (registration side effect)
...
def register_all():
    ...
    for module in (phone, sms, form_fill, webhook_poster, curatr_fix):
        try:
            module.register()
        except ValueError:
            pass
